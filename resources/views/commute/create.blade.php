            ...
            <div class="col-12 col-md-10">
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="">New commute</h5><a href="{{ route('Commute.index') }}" class="btn btn-dark">back</a>
                        </div>
                    <div class="card-body">
                <form action="{{route('Commute.store')}}" method="POST">
                            ...
                            <select id="user" name="user" class="form-select @error('password') is-invalid @enderror">
